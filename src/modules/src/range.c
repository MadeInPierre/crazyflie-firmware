...
LOG_ADD(LOG_UINT16, frontright, &ranges[rangeFrontRight])
LOG_ADD(LOG_UINT16, backright, &ranges[rangeBackRight])
LOG_ADD(LOG_UINT16, frontleft, &ranges[rangeFrontLeft])
LOG_ADD(LOG_UINT16, backleft, &ranges[rangeBackLeft])
